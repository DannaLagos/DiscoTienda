...
public class Discotienda
{
    ...
    public void generarReciboDIscosMasCostosos() throws FileNotFoundException{
    	File discosCostososRyP = new File("./data/discosCostosos.txt");
    	...
    	for ( int i =0 ;  i< discos.size() ; i ++ ) {
    		...
    		if(miDisco.darGenero().equals("Rock")|| miDisco.darGenero().equals("Pop")) {
    			...
    			pluma2.println("Disco: "+ miDisco.darNombreDisco()+ " Genero:"+ miDisco.darGenero()+" Precio: "+ miDisco.darPrecioDisco() );
    ...
    {
    	try {
    		generarReciboDIscosMasCostosos();
			return("Reporte generado exitosamente!!");
		} catch (Exception er) {
			// TODO Auto-generated catch block
			return("Error al generar el reporte, tipo: "+ er);
